...
class Game:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption('Yash Tanwar')
    ...
    def show_results(self, screen):
        if(not self.end):
            ...
            self.total_time = time.time() - self.time_start   #Calculate time
            ...
            for i, c in enumerate(self.word):
                try:
                    ...
                    pass
            self.accuracy = count/len(self.word)*100    #Calculate accuracy
            ...
            self.draw_text(screen, "Reset", self.h - 70, 26, (100, 125, 100))
